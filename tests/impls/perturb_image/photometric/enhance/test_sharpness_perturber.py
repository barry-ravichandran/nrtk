...
from nrtk.impls.perturb_image.photometric.enhance import SharpnessPerturber
...
@pytest.mark.pillow
class TestSharpnessPerturber(PerturberTestsMixin):
    impl_class = SharpnessPerturber
