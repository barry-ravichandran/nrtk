...
from nrtk.impls.perturb_image.photometric.blur import MedianBlurPerturber
...
@pytest.mark.opencv
class TestMedianBlurPerturber(PerturberTestsMixin):
    impl_class = MedianBlurPerturber
