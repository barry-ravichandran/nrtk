...
def compute_refraction_mapping_impl(
    *,
    xs: np.ndarray,
    ys: np.ndarray,
    gls: np.ndarray,
...
# Apply numba JIT compilation for performance
