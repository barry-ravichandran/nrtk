"""COCO-backed MAITE Object Detection dataset and conversion utilities.

These classes require the ``tools`` extra (kwcoco, Pillow).
"""

from __future__ import annotations

__all__ = ["COCOMAITEObjectDetectionDataset", "dataset_to_coco"]
